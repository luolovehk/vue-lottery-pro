  ...
  <div class="lottery-action">
    <div id="menu">
      ...
      <div style="display:flex;margin-left:30px;">
        <button id="lotteryStart" v-if="!isStart" @click="lotteryStart" style="background-color:#3b3b34;color:#ffd000;font-size:22px;font-weight:600;">开始抽奖</button>
        <button id="lotteryStop" v-else @click="lotteryStop" style="background-color:#ffd000;color:#000;font-size:22px;font-weight:600;">停止抽奖</button>
